...
description: "Remove saved segments you no longer need in WhiteWhale. Deleting a segment removes the saved filter view but does not affect the underlying account data."
---
