...
<Steps>
  ...
  <Step title="Ask Claude to connect">
    In any chat, ask Claude to connect to WhiteWhale. It will prompt you for your **API key** and **user email** — enter both and you're connected.
  </Step>
  <Step title="Try it">
    Ask Claude: _"Show me my hottest WhiteWhale accounts"_ — Claude will pull your live data and respond.
  </Step>
</Steps>
