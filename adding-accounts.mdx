...
description: "Add accounts to WhiteWhale from a domain list, CSV upload, or let the suggestion engine surface the best-fit companies. Start monitoring signals in minutes."
---
